...
public class RadarLayout extends FrameLayout {
    ...
    private static final float DEFAULT_STARTRATIO = 0.5f;
    ...
    public RadarLayout(Context context) {
        super(context);
        initGlobalparams(context,null);
    }

    public RadarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initGlobalparams(context,attrs);
    }
    ...
    private void initGlobalparams(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RadarLayout);

        mCount = typedArray.getInt(R.styleable.RadarLayout_CircleCount,DEFAULT_COUNT);
        mColor = typedArray.getColor(R.styleable.RadarLayout_CircleColor,DEFAULT_COLOR);
        mDuration = typedArray.getInt(R.styleable.RadarLayout_Duration,DEFAULT_DURATION);
        mStartRatio = typedArray.getFloat(R.styleable.RadarLayout_StartRatio,DEFAULT_STARTRATIO);
    ...
    private void build() {
        ...
        for (int index = 0; index < mCount; index++) {
            ...
            // 属性动画
            animators.add(create(radarView, "scaleX", repeatCount, delay, mStartRatio, 1));
            animators.add(create(radarView, "scaleY", repeatCount, delay, mStartRatio, 1));
