...
public class ExpressionEvaluation {
     ...
     * @return
     */
    public static BigDecimal floatingPointCalc(String opt, BigDecimal num1, BigDecimal num2) {
        BigDecimal resultBigDecimal = new BigDecimal(0);
        switch (opt) {
            case "+":
                resultBigDecimal = num1.add(num2);
                break;
            case "-":
                resultBigDecimal = num1.subtract(num2);
                break;
            case "*":
                resultBigDecimal = num1.multiply(num2);
                break;
            case "/":
                resultBigDecimal = num1.divide(num2, 10, BigDecimal.ROUND_HALF_DOWN); // 注意此处用法
                break;
            default:
                break;
        }
...
//        System.out.println(isDoubleEquals(1.0E24, executeExpression("1000000000000*1000000000000 = ")));
        System.out.println(isDoubleEquals(-10, executeExpression("(2*(3-4))*5")));
    }
