...
public class DateTimePicker extends WheelPicker {
    ...
    private int selectedYearIndex = 0, selectedMonthIndex = 0, selectedDayIndex = 0, selectedHourIndex = 0,
...
//                layout.setWeightSum(5);
                ...
                hourView.setSelectedTextColor(textColorFocus);
                hourView.setUnSelectedTextColor(textColorNormal);
                hourView.setItems(hours, selectedHourIndex);
                hourView.setLineConfig(lineConfig);
                wheelViewParams.weight = 1.0f;
                hourView.setLayoutParams(wheelViewParams);
    ...
    protected void onSubmit() {
        ...
        switch (dateMode) {
            case YEAR_MONTH_DAY:
                ((OnYearMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(year, month, day, hour,
                        minute);
                break;
            case YEAR_MONTH:
