package com.uratio.pikers.widget;
...
import com.uratio.pikers.R;
import com.uratio.pikers.adapter.ArrayWheelAdapter;
...
import com.uratio.pikers.widget.view.WheelListView;
import com.uratio.pikers.widget.view.WheelView;
...
public class DateRangePicker extends WheelPicker {
    ...
    private int selectedYearIndex = 0, selectedMonthIndex = 0, selectedDayIndex = 0,
            selectedEndYearIndex = 0, selectedEndMonthIndex = 0, selectedEndDayIndex = 0;
...
//    }
    ...
    public void setSelectedItem(int year, int month, int day) {
        ...
        selectedEndYearIndex = findItemIndex(years, year);
    ...
    public void setSelectedItem(int yearOrMonth, int monthOrDay, int hour, int minute) {
        ...
        if (dateMode == MONTH_DAY) {
            ...
            selectedEndYearIndex = findItemIndex(years, yearOrMonth);
    ...
    public String getSelectedEndYear() {
        if (years.size() <= selectedEndYearIndex) {
            selectedEndYearIndex = years.size() - 1;
        }
        return years.get(selectedEndYearIndex);
    }
    ...
    public String getSelectedMonth() {
        ...
        return getTwoNum(months.get(selectedMonthIndex));
    }
    ...
    public String getSelectedEndMonth() {
        ...
        return getTwoNum(months.get(selectedEndMonthIndex));
    }
    ...
    public String getSelectedDay() {
        ...
        return getTwoNum(days.get(selectedDayIndex));
    }
    ...
    public String getSelectedEndDay() {
        ...
        return getTwoNum(days.get(selectedEndDayIndex));
    }

    public String getSelectedHour() {
        if (timeMode != NONE) {
            return getTwoNum(selectedHour);
        }
        return "";
    }
    ...
    public String getSelectedMinute() {
        if (timeMode != NONE) {
            return getTwoNum(selectedMinute);
        }
        return "";
    }

    private String getTwoNum(String number) {
    ...
    protected View makeCenterView() {
        View view = null;
        if (wheelModeEnable) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.layout_date_range_picker, null);
            ...
            final WheelView endYearView = view.findViewById(R.id.wv_end_year);
...
//                        dayView.setCurrentItem(selectedDayIndex);
            ...
            endYearView.setCanLoop(canLoop);
            endYearView.setTextSize(textSize);//must be called before setDateList
            endYearView.setSelectedTextColor(textColorFocus);
            endYearView.setUnSelectedTextColor(textColorNormal);
            endYearView.setLineConfig(lineConfig);
            endYearView.setAdapter(new ArrayWheelAdapter<>(years));
            endYearView.setCurrentItem(selectedEndYearIndex);
            endYearView.setLabel(yearLabel);
            endYearView.setDividerType(lineConfig.getDividerType());
            endYearView.setOnItemPickListener(new OnItemPickListener<String>() {
                @Override
                public void onItemPicked(int index, String item) {
                    selectedEndYearIndex = index;
                    if (onWheelListener != null) {
                        onWheelListener.onYearWheeled(selectedEndYearIndex, item);
                    }
                    if (!canLinkage) {
                        return;
                    }
            ...
            view = LayoutInflater.from(getContext()).inflate(R.layout.layout_date_picker, null);
            final WheelListView startYearView = view.findViewById(R.id.wv_start_year);
            final TextView labelStartYear = view.findViewById(R.id.label_start_year);
            final WheelListView startMonthView = view.findViewById(R.id.wv_start_month);
            final TextView labelStartMonth = view.findViewById(R.id.label_start_month);
            final WheelListView startDayView = view.findViewById(R.id.wv_start_day);
            final TextView labelStartDay = view.findViewById(R.id.label_start_day);
            final WheelListView endYearView = view.findViewById(R.id.wv_end_year);
            final TextView labelEndYear = view.findViewById(R.id.label_end_year);
            final WheelListView endMonthView = view.findViewById(R.id.wv_end_month);
            final TextView labelEndMonth = view.findViewById(R.id.label_end_month);
            final WheelListView endDayView = view.findViewById(R.id.wv_end_day);
            final TextView labelEndDay = view.findViewById(R.id.label_end_day);
            final TextView tvLine = view.findViewById(R.id.tv_line);

            tvLine.setText("-");
            tvLine.setTextSize(textSize);
            tvLine.setTextColor(textColorFocus);
...
//        if ((dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) && days.size() == 0) {
            ...
            startYearView.setCanLoop(canLoop);
            startYearView.setTextSize(textSize);//must be called before setDateList
            startYearView.setSelectedTextColor(textColorFocus);
            startYearView.setUnSelectedTextColor(textColorNormal);
            startYearView.setLineConfig(lineConfig);
            startYearView.setItems(years, selectedYearIndex);
            startYearView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    selectedYearIndex = index;
                    if (onWheelListener != null) {
                        onWheelListener.onYearWheeled(selectedYearIndex, item);
                    }
            ...
            labelStartYear.setText(yearLabel);
            labelStartYear.setTextSize(textSize);
            labelStartYear.setTextColor(textColorFocus);
            ...
            startMonthView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    isStartMonth = true;
                    selectedMonthIndex = index;
                    if (onWheelListener != null) {
            ...
            labelStartMonth.setText(monthLabel);
            labelStartMonth.setTextSize(textSize);
            labelStartMonth.setTextColor(textColorFocus);
            ...
            startDayView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    isStartDay = true;
                    selectedDayIndex = index;
                    if (onWheelListener != null) {
            ...
            labelStartDay.setText(dayLabel);
            labelStartDay.setTextSize(textSize);
            labelStartDay.setTextColor(textColorFocus);
            ...
            endYearView.setUnSelectedTextColor(textColorNormal);
            endYearView.setLineConfig(lineConfig);
            endYearView.setItems(years, selectedEndYearIndex);
            endYearView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    selectedEndYearIndex = index;
                    if (onWheelListener != null) {
                        onWheelListener.onYearWheeled(selectedEndYearIndex, item);
            ...
            labelEndYear.setText(yearLabel);
            labelEndYear.setTextSize(textSize);
            labelEndYear.setTextColor(textColorFocus);
            ...
            endMonthView.setUnSelectedTextColor(textColorNormal);
            endMonthView.setLineConfig(lineConfig);
            endMonthView.setItems(months, selectedEndMonthIndex);
            endMonthView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    isStartMonth = false;
                    selectedEndMonthIndex = index;
                    if (onWheelListener != null) {
            ...
            labelEndMonth.setText(monthLabel);
            labelEndMonth.setTextSize(textSize);
            labelEndMonth.setTextColor(textColorFocus);
            ...
            endDayView.setUnSelectedTextColor(textColorNormal);
            endDayView.setLineConfig(lineConfig);
            endDayView.setItems(days, selectedEndDayIndex);
            endDayView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                public void onItemSelected(int index, String item, boolean isUserScroll) {
                    isStartDay = false;
                    selectedEndDayIndex = index;
                    if (onWheelListener != null) {
            ...
            labelEndDay.setText(dayLabel);
            labelEndDay.setTextSize(textSize);
            labelEndDay.setTextColor(textColorFocus);
    ...
    public void onSubmit() {
        ...
        ((OnYearMonthDayRangePickListener) onDateTimePickListener).onDateTimePicked(year, startMonth, starDay,
    ...
    public interface OnYearMonthDayRangePickListener extends OnDateTimePickListener {
        ...
        void onDateTimePicked(String year, String monthStart, String dayStart, String endYear, String monthEnd, String dayEnd);
