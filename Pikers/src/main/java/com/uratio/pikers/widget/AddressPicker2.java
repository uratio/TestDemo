...
public class AddressPicker2 extends LinkagePicker {
    ...
    public AddressPicker2(Activity activity, ArrayList<Province> provinces) {
...
//        super.makeCenterView();
        ...
        if (wheelModeEnable) {
            ...
            provinceView.setTextSize((float)textSize);
            ...
            cityView.setTextSize((float)textSize);
            ...
            countyView.setTextSize((float)textSize);
            ...
            WheelListView provinceView = new WheelListView(activity);
            provinceView.setCanLoop(canLoop);
            provinceView.setLayoutParams(new LinearLayout.LayoutParams(provinceWidth, -2));
